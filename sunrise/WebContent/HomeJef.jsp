                ...
                <li class="has-children">
                    ...
                    <ul>
                        <li class="has-children">
                            ...
                            <ul>
                                <li><a href="jefeturn/EmpleadoHoras.jsp" target="MainBody" onclick="return closePanel();" >Acciones</a></li>
                                <li><a href="#0" target="MainBody"  onclick="return closePanel();"> Horas Trabajadas</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
